...
*   [docs/csv/gold_features.csv](file:///C:/Users/Husnain/.gemini/antigravity/scratch/investment-platform/docs/csv/gold_features.csv) (75,079 rows)
*   [docs/csv/backtest_report.csv](file:///C:/Users/Husnain/.gemini/antigravity/scratch/investment-platform/docs/csv/backtest_report.csv) (266 rows)
*   [docs/csv/recommendations.csv](file:///C:/Users/Husnain/.gemini/antigravity/scratch/investment-platform/docs/csv/recommendations.csv) (10 signals)
...
Showcase the temporal strategy vs. benchmark performance curve located at: [docs/backtest_equity_curve.png](file:///C:/Users/Husnain/.gemini/antigravity/scratch/investment-platform/docs/backtest_equity_curve.png).
...
```
This script will automatically authenticate via SSL using `python-tds` and load the Gold features to your Synapse Dedicated SQL Pool.
